 ...
 */
     ...
     * 
     * @return bool - если данный обработчик вызывается после ошибки вызванной в функции с @, 
    ...
    protected function makeHeader($errno, $errstr, $errfile, $errline, $rescode)
    {
        if (!headers_sent($filename, $linenum)) {
            ...
            if (isset($this->ErrorCodeArray[$rescode])) {
                $resstr .= " " . $this->ErrorCodeArray[$rescode];
            }
        ...
        } else // if( 'cli' !== PHP_SAPI )
        {
            while (ob_get_level() > 0) {
                echo ob_get_clean(); /* ob_end_clean(); */
            }
        }
    }
} // TRMErrorHandler
