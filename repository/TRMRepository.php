...
abstract class TRMRepository implements TRMRepositoryInterface
{
  ...
  /**
   * @var bool - после каждого запроса на получение коллекции (getAll, getBy) все параметры запроса обнуляются,
  ...
  public function getOne(TRMDataObjectInterface $DataObject = null)
  {
    ...
    // если в запросе нет данных, возвращается пустая коллекция
    if (!$result->num_rows) {
      return null;
    }
