...
/**
 * вспомогательная функция, устанавливает параметры полей в массив $this->SafetyFieldsArray[$TableName]["Fields"],
...
/**
 * вспомогательная функция, добавляет параметры полей в массив $this->SafetyFieldsArray[$TableName]["Fields"],
